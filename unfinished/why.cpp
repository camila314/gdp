PlayerObject17collidedWithSlopeEfP10GameObjectb(int arg0, int arg1, int arg2) {
    r15 = arg2;
    rbx = arg1;
    r14 = arg0;
    var_48 = xmm0, arg2;
...
loc_10021d90f:
    var_44 = r15;
    rax = *r14;
    rax = GameObject::getObjectRect(r14);
    cocos2d::CCRect::CCRect(var_E0, rax);
    rax = *rbx;
    rax = GameObject::getObjectRect(rbx);
...
loc_10021db11:
    ...
    var_40 = rbx;
    xmm0 = *(int32_t *)(GameObject::getLastPosition(r14) + 0x4);
    ...
    rax = !rbx;
    xmm1 = intrinsic_ucomiss(xmm1, 0.00);
    if (xmm1 > 0x0) {
            r12 = 0x1;
            if (rax == 0x0) {
...
loc_10021ea66:
    if ((*(int8_t *)(r15 + 0x62c) != 0x0) && (*(int8_t *)(PL + 0x700) == 0x0)) {
            PlayLayer::destroyPlayer(PL, r15, 0x0, rcx, r8, r9);
    } else {
    ...
    if (r12 != 0x0) {
            ...
            if (var_B0 != 0x0) {
                    ...
                    *(int8_t *)(r15 + 0x7a0) = 0x0;
                    ...
                    xmm0 = *(int32_t *)((*(*r15 + 0x4f8))(r15) + 0xc);
                    xmm0 *= 0.5;
                    var_60 = xmm0;
                    rax = *r15;
                    rax = (*(rax + 0xc0))(r15);
                            ...
                            *(int8_t *)(r15 + 0x568) = 0x0;
                            if (*(int8_t *)(r15 + 0x779) == 0x0) {
                                    ...
                                    *(int8_t *)(r15 + 0x568) = (COND ? 0x1 : 0x0) | rax;
                                    xmm2 = *(int32_t *)(r15 + 0x77c);
                                    xmm0 = *(int32_t *)(r15 + 0x780);
...
loc_10021ded8:
    ...
    xmm2 = var_60;
    if (!COND) {
            xmm2 = *(int32_t *)(0x100511110 + (*(int8_t *)(r15 + 0x769) & 0xff) * 0x4);
    }
    goto loc_10021defb;
...
loc_10021df53:
    var_2C = intrinsic_mulss(intrinsic_movss(xmm0, *(int32_t *)(r15 + 0x77c)), 20.0);
    r13 = 0x1;
    goto loc_10021dd94;
